...
- 2026-09-24 13:00 CST — promoted Offload or Overload (2603.18284) to CORE_SYS after Microsoft GPU-offload reverse-neighborhood recovery; added Microsoft Physical AI Toolchain as runtime-project WATCH; exact-24h OAI PASS.
## 2026-09-24 12:00 CST — GLASS + runtime-adaptive streaming promotions
...
- **2026-09-03 15:58 CST** — Added llm-d Router multimodal stateful-routing frontier to runtime-project WATCH: async video job-owner routing (#2663), audio/video coordinator support (#2650), E2E coverage (#2641), and stage-aware multimodal cache ownership evidence (#2628). No paper promotion or taxonomy split.
- **2026-09-03 16:58 CST** — Added vLLM-Omni LTX output-materialization/transport A/B (#7000) and XPU buffer/output-lifetime evidence (#6996/#7001/#6997/#6989) to the media-stage runtime frontier; SGLang multimodal NPU correctness (#37758) was also checked. No canonical paper/project promotion or taxonomy split.
